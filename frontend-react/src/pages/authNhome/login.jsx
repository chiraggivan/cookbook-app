        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 m-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-2 border-0">
            ...
            <button
              ...
              // w-full bg-blue-400 text-white py-3 rounded-lg font-medium hover:bg-blue-700 transition
            >
              Login
            </button>
          </form>
          ...
          <button className="w-full flex text-gray-700 items-center justify-center gap-3 border border-gray-300 py-3 rounded-lg hover:bg-gray-100 hover:cursor-pointer transition">
            <svg
