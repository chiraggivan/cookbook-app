  ...
  return (
    <>
      ...
      <div className="flex flex-col mt-4 mx-25">
        {/* Name */}
        <div className="flex p-2 my-2 items-center font-semibold">
          ...
          <div className="flex">
            <div className="flex-1 text-lg items-center">
              <div className="flex items-center">
                ...
                <Input
                  className="rounded-xl max-w-25 border-gray-400 bg-gray-50 focus:bg-white"
                  value={ingData?.cup_equivalent_weight ? ingData?.cup_equivalent_weight : ""}
                  onChange={(e) => validateInput("cup_equivalent_weight", e.target.value, 3, 5)}
                  onBlur={() => validateNumber("cup_equivalent_weight")}
